    ...
    breakdown: [
      {
        ...
        icon: "✈️",
        amount: 115,
        perUnit: { amount: 95, amountMax: 135, unit: " PRG→FAO" },
        color: "#4A90E2",
      ...
      },
      {
        ...
        icon: "🏨",
        amount: 135,
        perUnit: { amount: 45, unit: "/night × 3" },
        color: "#FF6B47",
      ...
      },
      {
        ...
        icon: "🎭",
        amount: 45,
        perUnit: { amount: 15, unit: "/day avg" },
        color: "#F4A261",
      ...
      },
      {
        ...
        icon: "🚌",
        amount: 20,
        perUnit: { unit: "local buses + 1 taxi" },
        color: "#8E7CC3",
