    ...
    breakdown: [
      {
        ...
        icon: "✈️",
        amount: 0,
        perUnit: { unit: "Already in Prague — staycation" },
        color: "#4A90E2",
      ...
      },
      {
        ...
        icon: "🏨",
        amount: 132,
        perUnit: { amount: 22, unit: "/night × 6" },
        color: "#FF6B47",
    ...
    breakdown: [
      {
        ...
        icon: "✈️",
        amount: 110,
        perUnit: { unit: "PRG → FAO round-trip" },
        color: "#4A90E2",
      ...
      },
      {
        ...
        icon: "🎭",
        amount: 35,
        perUnit: { unit: "Cave kayak + Sagres bus" },
        color: "#F4A261",
      ...
      },
      {
        ...
        icon: "🚌",
        amount: 15,
        perUnit: { unit: "Buses + airport transfer" },
        color: "#8E7CC3",
    ...
    breakdown: [
      {
        ...
        icon: "✈️",
        amount: 130,
        perUnit: { unit: "PRG → VIE round-trip" },
        color: "#4A90E2",
      ...
      },
      {
        ...
        icon: "🏨",
        amount: 168,
        perUnit: { amount: 28, unit: "/night × 6" },
        color: "#FF6B47",
      ...
      },
      {
        ...
        icon: "🎭",
        amount: 25,
        perUnit: { unit: "Salt mine + lake ferry" },
        color: "#F4A261",
