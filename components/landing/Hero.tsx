        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-6 sm:gap-10">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-display font-bold tabular-nums tracking-tight text-accent-deep">1000+</div>
            ...
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-display font-bold tabular-nums tracking-tight text-accent-deep">60+</div>
              <div className="text-[11px] font-medium tracking-[0.15em] uppercase text-[#0D7377]/70 mt-1">countries</div>
            </div>
            <div className="w-px h-8 bg-[#0D7377]/20" />
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-display font-bold tabular-nums tracking-tight text-accent-deep">200+</div>
